        ...
        let layout = UICollectionViewCompositionalLayout { section, env in
            ...
            if section == 0 {
                ...
                let itemSize = NSCollectionLayoutSize(
                       ...
                       // GROUP
                       let groupSize = NSCollectionLayoutSize(
                           widthDimension: .absolute(260),   // card width
                           heightDimension: .absolute(300)   // card height
                       )
                       let group = NSCollectionLayoutGroup.horizontal(
                           layoutSize: groupSize,
                           subitems: [item]
...
extension VibeViewController {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if indexPath.section == 2 {
            ...
            case 0:
                performSegue(withIdentifier: "LoveNoteSheet", sender: nil)
            case 1:
                performSegue(withIdentifier: "LoveTipsModal", sender: self)
            case 2:
                performSegue(withIdentifier: "ActivityForHerVC", sender: self)
            default: break
            }
            return
        }
        ...
        // -------------------------
        // SECTION 3 → Build Your Bond
        // -------------------------
        if indexPath.section == 3 {
            switch indexPath.row {
            case 0:
                performSegue(withIdentifier: "goToBond1", sender: nil)
            case 1:
                performSegue(withIdentifier: "goToBond2", sender: nil)
            case 2:
                performSegue(withIdentifier: "goToBond3", sender: nil)
            default: break
            }
            return
        }
