...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneWillEnterForeground(_ scene: UIScene) {
        ...
        // Cancel pending motivational notifications since the user is active
        ScheduleManager.shared.cancelScheduledNotifications()
    }
    ...
    func sceneDidEnterBackground(_ scene: UIScene) {
        ...
        // Only schedule if they have finished onboarding (e.g. they are actively using the app)
        let defaults = UserDefaults.standard
        if defaults.bool(forKey: "hasCompletedOnboarding") {
